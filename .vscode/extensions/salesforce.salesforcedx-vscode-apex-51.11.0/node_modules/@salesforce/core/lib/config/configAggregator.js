...
class ConfigAggregator extends kit_1.AsyncOptionalCreatable {
    ...
    constructor(options) {
        ...
        // there is no project.
        try {
            this.setLocalConfig(new config_1.Config(config_1.Config.getDefaultOptions(false)));
        }
        catch (err) {
        ...
        this.setGlobalConfig(new config_1.Config(config_1.Config.getDefaultOptions(true)));
