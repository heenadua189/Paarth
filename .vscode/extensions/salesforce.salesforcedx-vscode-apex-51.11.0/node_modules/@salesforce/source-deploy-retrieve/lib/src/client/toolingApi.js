    ...
    retrieveWithPaths(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.retrieve({
                ...
                components: collections_1.ComponentSet.fromSource(retrievePaths, { registry: this.registry }),
            });
        });
    }
    retrieve(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const mdComponent = options.components.getSourceComponents().next().value;
            ...
            try {
                ...
                retrieveResult = {
                    status: types_1.RetrieveStatus.Succeeded,
                    success: true,
