...
class ComponentConverter extends stream_1.Transform {
    constructor(targetFormat, registry, mergeSet) {
        super({ objectMode: true });
    ...
    _flush(callback) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                try {
                    for (var _b = __asyncValues(this.context.executeFinalizers()), _c; _c = yield _b.next(), !_c.done;) {
...
class StandardWriter extends ComponentWriter {
    constructor(rootDestination, resolver = new metadata_registry_1.MetadataResolver()) {
