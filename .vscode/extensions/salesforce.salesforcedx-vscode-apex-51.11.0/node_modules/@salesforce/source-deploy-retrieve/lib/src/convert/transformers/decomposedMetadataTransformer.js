...
class DecomposedMetadataTransformer extends baseMetadataTransformer_1.BaseMetadataTransformer {
            ...
            if (component.parent) {
                ...
                this.context.recomposition.setState((state) => {
                    if (state[fullName]) {
                        ...
                        state[fullName] = {
                            component,
                            children: new collections_1.ComponentSet(component.getChildren(), this.registry),
                        };
                    }
                });
            }
    ...
    toSourceFormat(component, mergeWith) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const childrenOfMergeComponent = mergeWith
                ? new collections_1.ComponentSet(mergeWith.getChildren(), this.registry)
                : undefined;
            let parentXmlObject;
            ...
            if (!parentState && parentXmlObject) {
                ...
                else if (!((_c = parentState) === null || _c === void 0 ? void 0 : _c.foundMerge)) {
    ...
    setDecomposedState(forComponent, props = {}) {
        ...
        const withOrigin = Object.assign({ origin: (_a = forComponent.parent, (_a !== null && _a !== void 0 ? _a : forComponent)) }, props);
        this.context.decomposition.setState((state) => {
            var _a;
            state[key] = Object.assign((_a = state[key], (_a !== null && _a !== void 0 ? _a : {})), withOrigin);
        });
    }
    ...
    getDefaultOutput(component) {
        ...
        if (((_a = parent) === null || _a === void 0 ? void 0 : _a.type.strategies.decomposition) === "folderPerType" /* FolderPerType */) {
