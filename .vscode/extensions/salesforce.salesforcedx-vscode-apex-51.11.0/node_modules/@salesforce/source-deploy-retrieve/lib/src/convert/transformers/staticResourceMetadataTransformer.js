...
class StaticResourceMetadataTransformer extends baseMetadataTransformer_1.BaseMetadataTransformer {
    ...
    toSourceFormat(component, mergeWith) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (content) {
                ...
                const mergeContentPath = (_b = mergeWith) === null || _b === void 0 ? void 0 : _b.content;
                ...
                if (shouldUnzipArchive) {
                    ...
                    try {
                        for (var _d = __asyncValues(this.createWriteInfosFromArchive(zipBuffer, baseContentPath)), _e; _e = yield _d.next(), !_e.done;) {
                            const info = _e.value;
                ...
                writeInfos.push({
                    source: component.tree.stream(xml),
                    output: ((_c = mergeWith) === null || _c === void 0 ? void 0 : _c.xml) || component.getPackageRelativePath(path_1.basename(xml), 'source'),
                });
            }
            return writeInfos;
        });
    ...
    getBaseContentPath(component, mergeWith) {
        var _a;
        const baseContentPath = ((_a = mergeWith) === null || _a === void 0 ? void 0 : _a.content) || component.getPackageRelativePath(component.content, 'source');
